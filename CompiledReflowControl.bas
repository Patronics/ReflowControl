...
'----UPDATED AT 08:37PM, March 22, 2024----
'----SAVING AS CompiledReflowControl.bas ----

'---BEGIN ReflowControl.bas ---
'reflowControl.bas
'Patrick Leiser, March 2023
'controller hardware based on smart shelf mech 90 project.


#PICAXE 20M2      'CHIP VERSION PARSED
...
gosub cleardisp
if sw=1 then
;#serout(254, 128, "Knob Homing...")', 254, 192, "", 254, 148,  "Description...") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 0
w1 = 15
gosub print_table_serout
'	gosub autohome
	servo knobServo, 100
else
	do
...
;#serout (254, 192, "Scanning Bins...") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 16
w1 = 33
gosub print_table_serout
...
gosub cleardisp
;#serout (254, 128, "Wave 0") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 34
w1 = 41
gosub print_table_serout
...
dispBinPage:
;#serout (254, 128, "Wave ") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 42
w1 = 48
gosub print_table_serout
...
;#serout (254, 128, "Menu:",254,192,"> Man Ctrl", 254, 202, "  ", $b3,"dateDta", 254,148, "  Bin Data", 254, 158, "  Status  ", 254, 214, "option E", 254, 222, "  Return") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 49
w1 = 123
gosub print_table_serout
...
showStatus:
	gosub flashledsandcleardisp
showStatusLoop:
;#serout (254, 128, "Status: ") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 124
w1 = 133
gosub print_table_serout
...
updatemenu:
;#serout (254,192," ", 254, 202, " ", 254,148, " ", 254, 158, " ", 254, 212, " ", 254, 222, " ") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 134
w1 = 151
gosub print_table_serout
...
gosub clearleds
gosub flashledsandcleardisp
;#serout (254, 128, "Manual Control:",254,192,"> Servo Lo", 254, 202,"  Servo ",0xBD," ", 254,148, "  Servo Hi ", 254, 158, "  Temp70", 254, 212, "  Temp100", 254, 222, "  Return") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 152
w1 = 236
gosub print_table_serout
...
startHeatRoutine:
	gosub showProfileInfo
;#serout (254,140, "Loading") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 237
w1 = 245
gosub print_table_serout
...
continueHeatRoutine:
	...
	if localvar = 0x20 then 'end state
		...
		routineActiveFlag = 0
		targetTemp = 0
;#serout (254,222,"done") 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 246
w1 = 251
gosub print_table_serout
...
updateBinList:
	gosub cleardisp
;#serout (254,128,"Updating Pro List", 254, 192) 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 252
w1 = 272
gosub print_table_serout
...
;#serout ("Loading", 254, 148) 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 273
w1 = 281
gosub print_table_serout
	else
;#serout ("Failed", 254, 148) 'Evaluated below
gosub backup_table_sertxd ; Save the values currently in the variables
w0 = 282
w1 = 289
gosub print_table_serout
...
table 0, (254,128,"Knob Homing...") ;#serout
table 16, (254,192,"Scanning Bins...") ;#serout
table 34, (254,128,"Wave 0") ;#serout
table 42, (254,128,"Wave ") ;#serout
table 49, (254,128,"Menu:",254,192,"> Man Ctrl",254,202,"  ",$b3,"dateDta",254,148,"  Bin Data",254,158,"  Status  ",254,214,"option E",254,222,"  Return") ;#serout
table 124, (254,128,"Status: ") ;#serout
table 134, (254,192," ",254,202," ",254,148," ",254,158," ",254,212," ",254,222," ") ;#serout
table 152, (254,128,"Manual Control:",254,192,"> Servo Lo",254,202,"  Servo ",0xBD," ",254,148,"  Servo Hi ",254,158,"  Temp70",254,212,"  Temp100",254,222,"  Return") ;#serout
table 237, (254,140,"Loading") ;#serout
table 246, (254,222,"done") ;#serout
table 252, (254,128,"Updating Pro List",254,192) ;#serout
table 273, ("Loading",254,148) ;#serout
table 282, ("Failed",254,148) ;#serout
